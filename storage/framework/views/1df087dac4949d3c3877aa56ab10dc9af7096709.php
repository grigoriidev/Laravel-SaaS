          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                ...
                <h4>Here you can test the credentials EPTI currently uses to connect to "Stripe".</h4>
                <br/>
                <button class="btn btn-success" style="color: white;">Test</button>
                <br/>
                <h3><b>Change Credentials</b></h3>
                <h4>Here you can update the credentials EPTI uses to connect to "Stripe".</h4>
                <br/>
                <h4>To register your Stripe account please do the following:</h4>
                
                <div style="width:80%" class="ng-scope">
                    <ul>
                        <li style="margin-bottom: 5px;">Press <b>Authenticate</b> to open the Stripe login page.</li>
                        <li style="margin-bottom: 5px;">Login to Stripe .</li>
              ...
              <div class="tab-pane" id="tab_2">
                ...
                <?php echo e(Form::text('app','stripe',['style' => 'display: none'])); ?>
              ...
              <div class="tab-pane" id="tab_3">
                ...
                <h4>Here you can delete "Stripe". Deleted apps will no longer appear in your Applications list.</h4>
                <br/>
