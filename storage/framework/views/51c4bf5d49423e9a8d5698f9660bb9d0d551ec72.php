...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo e(url('/')); ?>/bower_components/admin-lte/plugins/iCheck/square/blue.css">
...
<body class="hold-transition <?php echo $__env->yieldContent('css_page_name'); ?>">
...
<!-- iCheck -->
<script src="<?php echo e(url('/')); ?>/bower_components/admin-lte/plugins/iCheck/icheck.min.js"></script>
<script>
    $(function () {
        $('input').iCheck({
