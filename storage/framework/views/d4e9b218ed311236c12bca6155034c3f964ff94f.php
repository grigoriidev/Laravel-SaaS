          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                ...
                <h4>Here you can test the credentials EPTI currently uses to connect to "WooCommerce".</h4>
                <br/>
                <button class="btn btn-success" style="color: white;">Test</button>
                <br/>
                <h3><b>Change Credentials</b></h3>
                <h4>Here you can update the credentials EPTI uses to connect to "WooCommerce".</h4>
                <br/>
                <h4>To register your WooCommerce account please do the following:</h4>
                
                <div style="width:80%" class="ng-scope">
                    <ul>
                        <li style="margin-bottom: 5px;">Press <b>Authenticate</b> to open the WooCommerce login page.</li>
                        <li style="margin-bottom: 5px;">Login to WooCommerce .</li>
              ...
              <div class="tab-pane" id="tab_2">
                ...
                <br/>
                <?php echo e(Form::open(array('action'=>'AppSettingController@renameApp', 'method' => 'post'))); ?>  

                <?php echo e(Form::text('appname',$name,['style' => 'width: 30%; height: 35px'])); ?>

                <?php echo e(Form::text('app','woocommerce',['style' => 'display: none'])); ?>

                <?php echo e(Form::text('id',$id,['style' => 'display: none'])); ?>

                <br/>
                <?php echo e(Form::submit('Save',['class' => 'btn btn-success', 'style' => 'margin-top: 20px;'])); ?>
              ...
              <div class="tab-pane" id="tab_3">
                ...
                <h4>Here you can delete "WooCommerce". Deleted apps will no longer appear in your Applications list.</h4>
                <br/>
                
                <br>
                <?php echo e(Form::open(array('action'=>'AppSettingController@deleteApp', 'method' => 'post'))); ?> 
                 
                    <?php echo e(Form::text('app','woocommerce',['style' => 'display: none'])); ?>

                    <?php echo e(Form::text('id',$id,['style' => 'display: none'])); ?>

                    <?php echo e(Form::submit('Delete',['class' => 'btn btn-danger', 'style' => 'font-size: 15px'])); ?>
