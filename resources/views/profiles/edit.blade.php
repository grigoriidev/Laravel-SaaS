                                        ...
                                        <div class="row" data-toggle="buttons">
                                            <div class="col-xs-6 right-btn-container">
                                                <label class="btn btn-primary @if($user->profile->avatar_status == 0) active @endif btn-block btn-sm"
                                                       ...
                                                       data-target=".collapseOne:not(.in), .collapseTwo.in">
                                                    <input type="radio" name="avatar_status" id="option1"
                                                           autocomplete="off" value="0"
                                                           @if($user->profile->avatar_status == 0) checked @endif> Use
                                                    Gravatar
                                                </label>
                                            </div>
                                            <div class="col-xs-6 left-btn-container">
                                                <label class="btn btn-primary @if($user->profile->avatar_status == 1) active @endif btn-block btn-sm"
                                                       data-toggle="collapse"
                                                       data-target=".collapseOne.in, .collapseTwo:not(.in)">
                                                    <input type="radio" name="avatar_status" id="option2"
                                                           autocomplete="off" value="1"
                                                           @if($user->profile->avatar_status == 1) checked @endif> Use
                                                    My Image
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div id="deleteAccount" class="tab-pane fade">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-sm-offset-3 margin-bottom-3 text-center">
                                                ...
                                                <div class="btn-group btn-group-vertical margin-bottom-2"
                                                     data-toggle="buttons">
...
@section('page_level_js')
    <script src="{{ url('/') }}/bower_components/hideShowPassword/hideShowPassword.min.js"></script>
    <script src="{{ url('/') }}/bower_components/dropzone/dist/dropzone.js"></script>
    <script src="{{ url('/') }}/bower_components/password-strength-meter/dist/password.min.js"></script>
    <script src="{{ url('/') }}/js/pages/admin/profile.js"></script>
    ...
    <script type="text/javascript">
        ...
        $('.profile-trigger').click(function () {
            $('.box').alterClass('box-*', 'box-default');
        });

        $('.settings-trigger').click(function () {
            $('.box').alterClass('box-*', 'box-info');
        });

        $('.admin-trigger').click(function () {
            $('.box').alterClass('box-*', 'panel-warning');
        ...
        $('.danger-pill-trigger').click(function () {
            $('.box').alterClass('box-*', 'panel-danger');
        });
