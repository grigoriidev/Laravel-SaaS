                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            @if(Auth::user()->activated)
                                <img src="{{ Auth::user()->profile->avatar }}" class="user-image" alt="">
                            @endif
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                @if(Auth::user()->activated)
                                    <img src="{{ Auth::user()->profile->avatar }}" class="img-circle" alt="">
                                @endif
                                <p>
                            ...
                            <li class="user-footer">
                                <div {{ Request::is('profile/'.Auth::user()->name, 'profile/'.Auth::user()->name . '/edit') ? 'class=active' : null }}" class="btn btn-default btn-flat class="pull-left" >
                                    {!! HTML::link(url('/profile/'.Auth::user()->name), trans('titles.profile')) !!}
                                </div>
                                <div class="pull-right">
                                    <a href="{{ route('logout') }}" class="btn btn-default btn-flat" onclick="event.preventDefault();
                                             document.getElementById('logout-form').submit();">{!! trans('titles.logout') !!}</a>
